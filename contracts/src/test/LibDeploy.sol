...
import { SetPieceNameSystem, ID as SetPieceNameSystemID } from "systems/SetPieceNameSystem.sol";
...
library LibDeploy {
  function deploy(
    ...
    if (!_reuseComponents) {
      ...
      console.log("Deploying PieceNameComponent");
      comp = new PieceNameComponent(address(result.world));
      console.log(address(comp));
  ...
  function deploySystems(
    ...
    console.log("Deploying SetPieceNameSystem");
    system = new SetPieceNameSystem(world, address(components));
    world.registerSystem(address(system), SetPieceNameSystemID);
    authorizeWriter(components, PieceNameComponentID, address(system));
    console.log(address(system));
