...
export interface MovePieceSystemInterface extends utils.Interface {
  functions: {
...
export interface MovePieceSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MovePieceSystemInterface;
