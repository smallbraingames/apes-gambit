...
export interface BRPiecePositionTrackerComponentInterface
...
export interface BRPiecePositionTrackerComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BRPiecePositionTrackerComponentInterface;
