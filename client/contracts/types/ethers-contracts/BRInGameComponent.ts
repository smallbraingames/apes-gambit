...
export interface BRInGameComponentInterface extends utils.Interface {
  functions: {
...
export interface BRInGameComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BRInGameComponentInterface;
