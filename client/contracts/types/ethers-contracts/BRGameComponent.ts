...
export type BRGameStructOutput = [BigNumber, number, number, number, number] & {
  startTime: BigNumber;
  rechargeTime: number;
...
export interface BRGameComponentInterface extends utils.Interface {
  functions: {
    ...
    "getEntitiesWithValue((uint256,uint32,uint16,uint16,uint8))": FunctionFragment;
    ...
    "set(uint256,(uint256,uint32,uint16,uint16,uint8))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "authorizeWriter"
      | "getEntities"
      | "getEntitiesWithValue((uint256,uint32,uint16,uint16,uint8))"
      ...
      | "remove"
      | "set(uint256,bytes)"
      | "set(uint256,(uint256,uint32,uint16,uint16,uint8))"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
      | "writeAccess"
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue((uint256,uint32,uint16,uint16,uint8))",
    values: [BRGameStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint256,uint32,uint16,uint16,uint8))",
