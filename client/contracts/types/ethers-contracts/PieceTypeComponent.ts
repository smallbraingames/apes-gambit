...
export interface PieceTypeComponentInterface extends utils.Interface {
  functions: {
...
export interface PieceTypeComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PieceTypeComponentInterface;
