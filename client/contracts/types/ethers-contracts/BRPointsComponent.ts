...
export interface BRPointsComponentInterface extends utils.Interface {
  functions: {
...
export interface BRPointsComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BRPointsComponentInterface;
