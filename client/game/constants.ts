...
export const INITIAL_ZOOM = 0.12;
export const GAME_WORLD_NAMESPACE = "game";
export const MOVE_ANIMATION_DURATION = 200;
export const TILE_OVERLAY_COLOR = 0x93e9ca;
export const TILE_OVERLAY_TAKE_COLOR = 0xff497f;
export const TILE_OVERLAY_RENDER_MULTIPLE = 1.5;
export const LOBBY_DISPLAY_GRID_SIZE = 200;
export const EDGE_PIXEL_SIZE = 100;
export const CAMERA_SCROLL_SPEED = 40;
